...
#
# ПЕРЕЕЗД НА СВОЙ ДОМЕН. Домен ещё не выбран, решение за владельцем.
# Когда он появится, меняется ровно эта строка, дальше пересборка разносит
# адрес по всем страницам, карте и llms. Внутренние ссылки относительные,
# переписывать их не надо.
#
# Менять ТОЛЬКО когда домен куплен и DNS отвечает: canonical, указывающий в
# пустоту, хуже старого адреса.
