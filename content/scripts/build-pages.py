...
PAGES = [
    {
        ...
        "title": "ВНЖ Кипра для финансово независимых лиц (Pink Slip) в 2026 году",
        "desc": "Временный вид на жительство Республики Кипр для тех, кто не работает на Кипре и живёт на доход из других стран. Его же называют визитёрским, гостевым и Pink Slip.",
        "h1": "ВНЖ для финансово независимых",
        "short": "Финансово независимые",
        "lead": "Путь для тех, кто живёт на Кипре, но зарабатывает не здесь: пенсия, аренда, дивиденды, накопления. Одно и то же основание называют по-разному: визитёрский ВНЖ, гостевой, категория Visitors, в разговоре чаще всего Pink Slip.",
        "hero_frame": "f_060",
        "who": [
    ...
    },
    {
        ...
        "title": "Виза цифрового кочевника на Кипре (Digital Nomad Visa) 2026",
        "desc": "Вид на жительство Республики Кипр для тех, кто работает удалённо на зарубежных работодателей и заказчиков. Программа Digital Nomad Visa.",
        "h1": "Цифровой кочевник",
        "short": "Цифровой кочевник",
        "lead": "Для тех, кто работает удалённо на компании и заказчиков за пределами Кипра и может это подтвердить документами. Официально программа называется Digital Nomad Visa, число мест в ней ограничено квотой.",
        "hero_frame": "f_120",
        "who": [
    ...
    },
    {
        ...
        "title": "ПМЖ Кипра за недвижимость и инвестиции в 2026 году",
        "desc": "Постоянный вид на жительство Республики Кипр при покупке недвижимости, а также через вложение в кипрскую компанию или инвестиционный фонд.",
        "h1": "ПМЖ за недвижимость",
        "short": "ПМЖ за недвижимость",
        "lead": "Постоянный статус при покупке недвижимости на Кипре. Тот же путь открыт через вложение в кипрскую компанию или инвестиционный фонд. Ежегодного продления не требует.",
        "hero_frame": "f_100",
        "who": [
    ...
    },
    {
        ...
        "title": "ВНЖ Кипра через трудоустройство и воссоединение семьи 2026",
        "desc": "Вид на жительство Республики Кипр по трудоустройству у кипрского работодателя и по воссоединению с семьёй.",
        "h1": "ВНЖ через работу и семью",
        "short": "Работа и семья",
        "lead": "Два разных пути с общей чертой: заявку двигает не только заявитель. При трудоустройстве её двигает работодатель на Кипре, при воссоединении член семьи, у которого уже есть статус.",
        "hero_frame": "f_130",
        "who": [
...
# В меню и на карточках стоит КОРОТКАЯ подпись, а не H1.
# H1 переписаны под живые формулировки поиска и стали длиннее: «ВНЖ для
# финансово независимых» в плитке «Другие основания» ломало бы сетку, а в
# бланке проверки лезло бы в три строки. Заголовок работает на поиск,
# подпись на глаз, и это разные задачи.
NAV = [(p["slug"], p.get("short", p["h1"])) for p in PAGES]
